...
mongoimport -h localhost -p 27017 -d EnInternalChatTest -c idManager /docker-entrypoint-initdb.d/0-idManager.json
...
mongoimport -h localhost -p 27017 -d EnInternalChat -c idManager /docker-entrypoint-initdb.d/0-idManager.json
